...
// Os 6 atalhos de uso diário. Relatórios e Configurações saíram daqui e
// agora vivem só no menu de hambúrguer do MobileHeader — ver o comentário
// em components/MobileHeader.tsx sobre por que o antigo botão "Mais" foi
// substituído.
const ITEMS = [
