...
// o último botão da BottomNav — ver components/BottomNav.tsx. Manter os
// dois ao mesmo tempo (um em cima, seis embaixo) tinha virado botão
// demais na tela; agora a barra de baixo é o único lugar de navegação.
